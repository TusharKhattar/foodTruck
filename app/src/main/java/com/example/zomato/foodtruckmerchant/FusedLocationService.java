...
public class FusedLocationService implements
    ...
    private static final long ONE_MIN = 1000 * 6;
    private static final long REFRESH_TIME = 1000*10 ;
    ...
    public FusedLocationService(Context locationActivity, LocationListener locationListener) {
